    ...
    <div className="bg-black flex flex-col md:flex md:flex-row text-white min-w-full h-28 md:h-16 text-md md:text-xl font-normal md:tracking-wider font-sans items-center justify-between fixed top-0 left-0 z-20">
      ...
      {isLoggedIn ? (
        <button
          ...
          className=" flex justify-center bg-rose-600 hover:bg-rose-800 text-lg items-center text-white md:text-lg font-semibold mt-8 py-2 px-3 md:mt-0 w-auto h-6 md:h-8 rounded-md md:mr-10"
        >
          Logout
        </button>
      ) : (
