...
function Footer() {
  return (
    <div className="backGroundAnimate bg-black flex flex-col md:flex md:justify-center md:items-center flex-wrap fixed bottom-0 left-0 min-w-full h-auto p-4 sm:p-8 lg:h-12 z-50 items-center pt-1 tracking-wider">
      ...
      <div className="flex gap-6 items-center justify-center mr-5 sm:mr-0">
